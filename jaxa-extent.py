...
def processAuto():
	...
	saveExtentGraph(3 if north else 6, 13.5 if north else 20, data, "JAXA " + hemisphereCapitalized + " sea ice extent", extentGraphFilename, 3 if north else 4)
